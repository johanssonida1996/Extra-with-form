...
// Lägg till en klick-händelse på varje länk
links.forEach(link => {
...
// Om sidan laddas, kolla vilken länk som är aktiv
const currentPath = window.location.pathname;
links.forEach(link => {
  if (link.getAttribute('href') === currentPath) {
    link.classList.add('active'); // Lägg till 'active' klassen på den aktuella sidan
  }
});
